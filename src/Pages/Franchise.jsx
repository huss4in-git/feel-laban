        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <input
              ...
              className="border-2 border-blue-400 rounded-xl p-3 w-full"
            />
            <input
              name="email"
          ...
          <input
            ...
            className="border-2 border-blue-400 rounded-xl p-3 w-full mb-4"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                name="ownedBusiness"
                checked={formData.ownedBusiness}
                onChange={handleChange}
            ...
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                name="beenFranchise"
                checked={formData.beenFranchise}
                onChange={handleChange}
                className="accent-blue-500"
              />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <input
              ...
              onChange={handleChange}
              placeholder="If Yes, Then What Type?"
              className="border-2 border-blue-400 rounded-xl p-3 w-full"
            />
            <input
              name="businessDesc"
          ...
          <label className="flex items-center gap-2 mb-4">
            <input
              type="checkbox"
              name="hasCommercialSpace"
              checked={formData.hasCommercialSpace}
              onChange={handleChange}
              className="accent-blue-500"
            />
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="Describe The Shop Location"
            className="border-2 border-blue-400 rounded-xl p-3 w-full mb-4"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <input
              ...
              onChange={handleChange}
              placeholder="Retail Space Area (sq.ft)"
              className="border-2 border-blue-400 rounded-xl p-3 w-full"
            />
            <input
              name="frontage"
              ...
              onChange={handleChange}
              placeholder="Frontage of the Retail Space"
              className="border-2 border-blue-400 rounded-xl p-3 w-full"
            />
          </div>
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="Demographics of the Location"
            className="border-2 border-blue-400 rounded-xl p-3 w-full mb-6"
          />
          ...
          <div className="flex justify-center gap-6">
            ...
            <button
              type="submit"
              className="bg-[#00aaff] text-white px-8 py-3 rounded-full hover:bg-blue-600 transition"
            >
              Submit
            </button>
          </div>
